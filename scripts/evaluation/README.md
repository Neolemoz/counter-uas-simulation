...
For SA platform integrity audits and `tier0-sa-r0` maintenance, see [`docs/evaluation/sa_stabilization_plan.md`](../../docs/evaluation/sa_stabilization_plan.md), [`docs/evaluation/sa_stabilization_freeze_audit.md`](../../docs/evaluation/sa_stabilization_freeze_audit.md), [`docs/evaluation/sa_platform_maintainer_checklist.md`](../../docs/evaluation/sa_platform_maintainer_checklist.md), and [`docs/evaluation/sa_r0_reviewer_quickstart.md`](../../docs/evaluation/sa_r0_reviewer_quickstart.md).
**PLAT-SA-H3 offline experiment orchestration (frozen):** [`run_experiment_queue.py`](run_experiment_queue.py), [`lint_experiment_manifest.py`](lint_experiment_manifest.py) — [`sa_h3_offline_orchestration_freeze_audit.md`](../../docs/evaluation/sa_h3_offline_orchestration_freeze_audit.md).
**PLAT-SA-I2 async orchestration foundations (frozen):** [`sa_i2_async_orchestration_plan.md`](../../docs/platform/sa_i2_async_orchestration_plan.md) — [`experiment_orchestration_async_operations_v1.md`](../../docs/evaluation/experiment_orchestration_async_operations_v1.md) — [`sa_i2_async_orchestration_freeze_audit.md`](../../docs/evaluation/sa_i2_async_orchestration_freeze_audit.md). CLIs: `record_async_execution.py`, `audit_orchestration_async_integrity.py`, `lint_orchestration_async_manifest.py`.
**PLAT-SA-I3 async recovery & batch review (frozen):** [`sa_i3_async_recovery_plan.md`](../../docs/platform/sa_i3_async_recovery_plan.md) — [`experiment_orchestration_async_recovery_v1.md`](../../docs/evaluation/experiment_orchestration_async_recovery_v1.md) — [`sa_i3_async_recovery_freeze_audit.md`](../../docs/evaluation/sa_i3_async_recovery_freeze_audit.md). CLIs: `audit_orchestration_recovery.py` (`--strict`, `--batch`, `--refresh-fixtures`); `record_async_execution.py --recovery-report`.
...
**PLAT-SA-A1 authoring (frozen):** [`promote_scenario_pack.py`](promote_scenario_pack.py), [`sync_authoring_mirrors.py`](sync_authoring_mirrors.py) — [`sa_a1_authoring_workstation_freeze_audit.md`](../../docs/evaluation/sa_a1_authoring_workstation_freeze_audit.md).

```bash
python3 scripts/evaluation/promote_scenario_pack.py fixtures/scenarios/PACK_ID --init
python3 scripts/evaluation/promote_scenario_pack.py fixtures/scenarios/PACK_ID --record-validation
python3 scripts/evaluation/promote_scenario_pack.py fixtures/scenarios/PACK_ID --status promoted
