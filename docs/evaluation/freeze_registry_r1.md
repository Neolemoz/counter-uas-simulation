...
| PLAT-RT-PLAN-LARGE1 | RT Large-Area Planning World (5/10/20 km extents, overlays, measurements, cognition; **not** runtime/bridge/MC/LOS/sensor) | frozen | [rt_large_area_planning_world_v1.md](rt_large_area_planning_world_v1.md), [rt_planning_large_area_governance_audit_v1.md](rt_planning_large_area_governance_audit_v1.md) | `planningWorld.ts`, `planningExtentLayer.ts`, `planningCognition.ts`, `planningMeasurements.ts`, Planning extent metadata in snapshots/packages, Planning Mode cognition panel |
