...
| PLAT-RT-LIVE-CONTROL-TRUTH1 | Live Gazebo control truth (WorldControl pause/resume/reset, bridge pause gate, clock sim-time, reset-while-paused; **not** telemetry schema, parser, autonomy, SA viewer) | frozen | [rt_live_control_truth_freeze_audit.md](rt_live_control_truth_freeze_audit.md) | `gz_tools.py` WorldControl helpers, `adapter_worker` live pause/reset, `gz_bridge_node` pause/reset gate, `rt_live_control_truth_v1.md`, `test_rt_gz_*.py`; commit `a8252c0` |
| PLAT-RT-LIVE-GZ1 | Web ↔ Gazebo live runtime V1 (UI profile, preflight, poll, stop, mirror/command health) | frozen | [rt_web_gazebo_live_runtime_v1.md](rt_web_gazebo_live_runtime_v1.md) | `live_preflight.py`, `runtime_profile: live`, `platform/rt-sandbox-ui/` live UX, [rt_live_telemetry_flow_v1.md](rt_live_telemetry_flow_v1.md), [rt_live_command_flow_v1.md](rt_live_command_flow_v1.md), [rt_live_runtime_validation_v1.md](rt_live_runtime_validation_v1.md), `scripts/rt/rt_live_smoke.py` |
...
| PLAT-RT-PLAN1 | RT Planning Mode evolution (UI-local polygon, radar, heuristic coverage) | frozen | [rt_planning_mode_evolution_v1.md](rt_planning_mode_evolution_v1.md) | `platform/rt-sandbox-ui/src/cesium/planningDrawing.ts`, Planning Mode workstation shell, visual-only coverage overlays |
| PLAT-RT-PLAN-TERRAIN1 | RT Planning Terrain Visualization (visual-only terrain + location presentation) | frozen | [rt_planning_terrain_visualization_v1.md](rt_planning_terrain_visualization_v1.md) | `terrainProviderConfig.ts`, `planningLocations.ts`, Planning Mode terrain/location controls, camera-only location jumps |
| PLAT-RT-COVERAGE-V2 | RT Coverage Analysis V2 (UI-local planning analytics + advisory overlays) | frozen | [coverage_analysis_v2.md](coverage_analysis_v2.md) | `planningCoverageAnalysis.ts`, `planningDrawing.ts`, Planning Mode analytics/advisory UI, display-only advisory Cesium overlays |
| PLAT-RT-PLAN-MC2 | Planning → Monte Carlo Integration V2 (UI-local snapshot/package/result linkage; **not** MC execution) | frozen | [planning_mc_integration_v2.md](planning_mc_integration_v2.md) | `planningMcSnapshot.ts`, `planningMcPackage.ts`, `planningMcResultLink.ts`, Planning Mode MC panels, [planning_mc_result_link_golden_v1.json](../../fixtures/rt_sandbox/planning_mc_result_link_golden_v1.json) |
| PLAT-RT-PLAN-LARGE1 | RT Large-Area Planning World (5/10/20 km extents; **superseded** by PLAT-RT-UNIFIED-WORLD-7KM1 for world authority) | superseded | [rt_large_area_planning_world_v1.md](rt_large_area_planning_world_v1.md), [rt_planning_large_area_governance_audit_v1.md](rt_planning_large_area_governance_audit_v1.md) | Legacy dual-world Planning docs; import-only extent IDs remain in `planningWorld.ts` |
| PLAT-RT-UNIFIED-WORLD-7KM1 | Unified 7 km RT world (bridge/UI bounds ±7000, operational rings, Cesium-primary editing, Planning collapse; **not** MC/parser/topic/SA) | frozen | [unified_7km_world_v1.md](unified_7km_world_v1.md) | `governance.py`, `bounds.ts`, `operationalRingLayer.ts`, `planningWorld.ts`, `planningCognition.ts`, `planningMcSnapshot.ts` (`world_bounds_m`), [planning_layout_compare_golden_v1.json](../../fixtures/rt_sandbox/planning_layout_compare_golden_v1.json), [live_smoke_trace_v1.json](../../fixtures/rt_sandbox/live_smoke_trace_v1.json) |
| PLAT-RT-PLAN-COMPARE1 | Planning Layout Comparison V1 (snapshot-based Slot A/B/C compare, deltas, side-by-side summaries, paste-import; **not** Cesium overlay diff / MC execution / persistence) | frozen | [planning_layout_comparison_v1.md](planning_layout_comparison_v1.md) | `planningLayoutComparison.ts`, `PlanningLayoutComparePanel.tsx`, Planning Mode compare panel in `AppWorkstationSlots.tsx`, [planning_layout_compare_golden_v1.json](../../fixtures/rt_sandbox/planning_layout_compare_golden_v1.json) |
| PLAT-RT-LAYOUT-MC-EXEC1 | Layout MC execution V1 (maintainer CLI prepare/execute/handoff; **not** UI execution, **not** Planning auto-import, **not** registry RT-1..7) | frozen | [rt_layout_mc_execution_v1_freeze.md](rt_layout_mc_execution_v1_freeze.md) | [rt_layout_monte_carlo_execution_v1.md](rt_layout_monte_carlo_execution_v1.md), `scripts/evaluation/rt_layout_mc_execute.py`, `scripts/evaluation/rt_layout_mc_planning_ref.py`, `src/counter_uas/test/test_rt_layout_mc_execute.py`, [rt_layout_mc_handoff_golden_v1.json](../../fixtures/rt_sandbox/rt_layout_mc_handoff_golden_v1.json), layout MC result/planning-ref golden fixtures |
...
| RT-MAINT-WF-V1 | RT maintainer workflow v1 | docs frozen | — | [rt_runtime_maintainer_workflow_v1.md](rt_runtime_maintainer_workflow_v1.md), [rt_runtime_capture_runbook.md](../platform/rt_runtime_capture_runbook.md), [rt_runtime_replay_import_v1.md](rt_runtime_replay_import_v1.md), [rt_runtime_replay_compare_v1.md](rt_runtime_replay_compare_v1.md) |
...
| PLAT-RT-C4 P2 | App entity-editing hook + workstation slots (**PLAT-RT-C4 complete**) | frozen (P2) | [rt_plat_c4_p2_freeze_audit.md](rt_plat_c4_p2_freeze_audit.md) | `useSessionEntityEditing.ts`, `AppWorkstationSlots.tsx`, [rt_plat_c4_p2_app_cleanup_plan.md](../platform/rt_plat_c4_p2_app_cleanup_plan.md) |
| PLAN-RT-X3 | Experiment workbench v3 ergonomics planning (**not** PLAT-RT-X3 P1–P2; **not** PLAN-RT-X2 replacement) | docs frozen | [rt_x3_freeze_audit.md](rt_x3_freeze_audit.md) | [rt_x3_experiment_workbench_v3_plan.md](../platform/rt_x3_experiment_workbench_v3_plan.md), [rt_experiment_workbench_v3_v1.md](rt_experiment_workbench_v3_v1.md), [rt_experiment_review_workflow_v3_v1.md](rt_experiment_review_workflow_v3_v1.md), [rt_experiment_compare_workflow_v3_v1.md](rt_experiment_compare_workflow_v3_v1.md), [rt_roadmap_plat_rt_x3_v1.md](rt_roadmap_plat_rt_x3_v1.md), [rt_roadmap_next_frontiers_v12.md](rt_roadmap_next_frontiers_v12.md) |
| PLAT-RT-X3 P0 | Workbench v3 shell — navigation, packet section preview, compare coach (**not** P1 review lane; **not** P2 compare polish) | frozen | [rt_plat_x3_p0_freeze_audit.md](rt_plat_x3_p0_freeze_audit.md) | `ExperimentWorkbenchV3Shell.tsx`, `reviewPacketSections.ts`, `compareStatusVocabulary.ts`, [rt_plat_x3_p0_workbench_v3_shell_plan.md](../platform/rt_plat_x3_p0_workbench_v3_shell_plan.md), [fixtures/rt_experiments/x3_review_packet_sections_example.json](../../fixtures/rt_experiments/x3_review_packet_sections_example.json) |
| PLAT-RT-X3 P1 | Review workflow — step badges, grouped dock, packet section cards, compare chips (**not** P2; export `sections[]` unchanged) | frozen | [rt_plat_x3_p1_freeze_audit.md](rt_plat_x3_p1_freeze_audit.md) | `reviewStepCompletion.ts`, `reportDockGroups.ts`, `ReviewPacketSectionCard.tsx`, `CompareStatusChip.tsx`, [rt_plat_x3_p1_review_workflow_plan.md](../platform/rt_plat_x3_p1_review_workflow_plan.md) |
| PLAT-RT-X3 P2 | Multi-manifest drill-down polish + packet preview ergonomics (**PLAT-RT-X3 complete**; export unchanged) | frozen | [rt_plat_x3_p2_freeze_audit.md](rt_plat_x3_p2_freeze_audit.md) | `multiManifestDiffColumns.ts`, `MultiManifestMetadataDrillDown.tsx`, `ReviewPacketGroupedSummary.tsx`, `packetSectionGroups.ts`, [rt_plat_x3_p2_multi_manifest_packet_plan.md](../platform/rt_plat_x3_p2_multi_manifest_packet_plan.md) |
| CHECKPOINT-RT-POST-X3 | Post-X3 platform maturity re-baseline after V4+C4+X3 (**docs only; no V5/F9/PLAT authority**) | docs frozen | [rt_checkpoint_post_x3_freeze_audit.md](rt_checkpoint_post_x3_freeze_audit.md) | [rt_checkpoint_post_x3_platform_review.md](../platform/rt_checkpoint_post_x3_platform_review.md), [rt_checkpoint_post_x3_maturity_review_r1.md](rt_checkpoint_post_x3_maturity_review_r1.md), [rt_checkpoint_post_x3_governance_review_r1.md](rt_checkpoint_post_x3_governance_review_r1.md), [rt_checkpoint_post_x3_technical_debt_audit_r1.md](rt_checkpoint_post_x3_technical_debt_audit_r1.md), [rt_roadmap_next_frontiers_v13.md](rt_roadmap_next_frontiers_v13.md) |
| PAUSE-RT-PLATEAU-V13 | Post-X3 operational plateau — hold frozen PLAT baseline (**docs only; no F9/V5/PLAT authority**) | docs frozen | [rt_pause_plateau_freeze_audit.md](rt_pause_plateau_freeze_audit.md) | [rt_pause_plateau_v13.md](../platform/rt_pause_plateau_v13.md), [rt_pause_plateau_review_r1.md](rt_pause_plateau_review_r1.md) |
...
| PLAT-RT-TACTICAL-VIS1 | Tactical visualization overlays — display-only Cesium layers for unified ±7 km world (**not** TAC command authority; **not** bridge/runtime/MC/SA changes) | frozen | [rt_tactical_visualization_v1.md](rt_tactical_visualization_v1.md) | `tacticalGeometry.ts`, `tacticalVisualScale.ts`, `tacticalPreset.ts`, `tactical*Layer.ts`, `tacticalViewGoldenFixture.ts`, `CesiumRuntimeView.tsx`, `CesiumRuntimePanel.tsx`, [fixtures/rt_visualization/tactical_view_7km_golden_v1.json](../../fixtures/rt_visualization/tactical_view_7km_golden_v1.json), [rt_tactical_visualization_smoke_checklist_v1.md](rt_tactical_visualization_smoke_checklist_v1.md) |
| PLAT-RT-INTEL1 | Counter-UAS intelligence advisory layer V1 (pure advisory engine + read-only transport; **not** UI rendering, assignment, engagement, SA, parser/topic changes) | frozen | [rt_intelligence_advisory_freeze_audit.md](rt_intelligence_advisory_freeze_audit.md) | `rt_intelligence_advisory_engine.py`, `rt_intelligence_advisory_transport.py`, `intelligence_advisory` telemetry channel, [rt_intelligence_advisory_v1.md](rt_intelligence_advisory_v1.md), [fixtures/rt_intelligence_advisory/](../../fixtures/rt_intelligence_advisory/) |
| PLAT-RT-INTEL-LIVE1 | Live-backed intelligence advisory assembly (explicit session protected center + registry positions + raw telemetry velocity + fail-closed publication; **not** assignment, engagement, autonomy, ROS/topic/channel/schema/parser changes) | frozen | [intel_live_v1.md](intel_live_v1.md) | `rt_intelligence_live.py`, session protected-center designation, existing `intelligence_advisory` transport, `test_rt_intelligence_live.py` |
| PLAT-RT-INTEL-UI1 | Intelligence Advisory UI V1 (read-only advisory panel/strip/selected-card; **not** assignment, approve/reject, engagement, autonomy, Cesium overlays, SA, parser/topic changes) | frozen | [intelligence_advisory_ui_v1.md](intelligence_advisory_ui_v1.md) | `platform/rt-sandbox-ui/src/intelligence/`, `intelligence_advisory` UI telemetry subscription, `CesiumRuntimePanel.tsx` advisory strip, `AppWorkstationSlots.tsx` advisory surfaces |
| PLAT-RT-THREAT-WB1 | Threat Evaluation Workbench V1 (workstation-level selected-advisory explanation; **not** telemetry, transport, schema, assignment, engagement, autonomy, or SA coupling) | frozen | [threat_evaluation_workbench_v1.md](threat_evaluation_workbench_v1.md) | `platform/rt-sandbox-ui/src/intelligence/workbench/`, `SelectedTargetAdvisoryCard.tsx`, `AppWorkstationSlots.tsx`, `intelligenceSelectors.ts` |
| PLAT-RT-TRACK-WB1 | Track & Sensor Workbench V1 (workstation-level fixture-backed selected-track explanation; **not** telemetry, bridge transport, ROS topics, schemas, tactical controls, assignment, engagement, autonomy, or SA coupling) | frozen | [track_sensor_workbench_v1.md](track_sensor_workbench_v1.md) | `platform/rt-sandbox-ui/src/tracks/workbench/`, `TrackSensorWorkbenchWorkstationSurface`, `AppWorkstationSlots.tsx` |
| PLAT-RT-TRACK-LIVE1 | Live track workbench V1 (selected entity + `entity_pose_mirror` + `intelligence_advisory` correlation through existing track workbench model; **not** tracker output, `/tracks/state`, tactical recommendation substitution, bridge/ROS/telemetry/schema changes, assignment, engagement, or autonomy) | frozen | [track_live_v1.md](track_live_v1.md) | `LiveTrackSensorAdapter`, `liveTrackSensorWorkbenchSelectors.ts`, `LiveTrackSensorWorkbenchSurface`, `trackLiveProvenance.ts`, `TrackSensorWorkbenchModel` reuse, fixture fallback |
| PLAT-RT-TRACE1 | Track → Threat Traceability Layer V1 (fixture-backed read-only lineage from track through advisory origin; **not** telemetry, bridge transport, ROS topics, schemas, tactical controls, assignment, engagement, autonomy, or SA coupling) | frozen | [track_threat_traceability_v1.md](track_threat_traceability_v1.md) | `platform/rt-sandbox-ui/src/traceability/workbench/`, `TrackTraceabilityWorkstationSurface`, `SelectedTrackTraceabilityWorkbench`, `traceabilitySelectors.ts`, `AppWorkstationSlots.tsx` |
| PLAT-RT-TRACE-LIVE1 | Live traceability layer V1 (selected entity + `entity_pose_mirror` + `intelligence_advisory` correlation; **not** tracker lineage, `/tracks/state`, tactical recommendation substitution, bridge/ROS/schema changes, assignment, engagement, or autonomy) | frozen | [trace_live_v1.md](trace_live_v1.md) | `LiveTraceabilityAdapter`, `liveTraceabilitySelectors.ts`, `LiveTraceabilityWorkbenchSurface`, `traceabilityProvenance.ts`, `TraceabilityWorkbenchModel` reuse, fixture fallback |
| PLAT-RT-PROTECTED-CENTER1 | Protected center designation UI V1 (explicit designate workflow, status strip, Cesium/SVG emphasis, recovery banners, UI-cache status; **not** auto-designation, telemetry/backend changes, tactical/assignment/engagement/autonomy) | frozen | [rt_protected_center_ui_freeze_audit.md](rt_protected_center_ui_freeze_audit.md) | [rt_protected_center_ui_v1.md](rt_protected_center_ui_v1.md), `protectedCenterCommands.ts`, `protectedCenterDesignation.ts`, `ProtectedCenterStatusStrip.tsx`, `ProtectedCenterRecoveryBanner.tsx`, `defenseZoneVisualState.ts`, `DesignateProtectedCenterButton.tsx`, `CesiumSelectedEntityActionRow.tsx`, `App.tsx` session cache; commit `b4bc9c0` |
